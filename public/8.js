        ...
        [
          _c("div", { staticClass: "xl:flex -mx-6" }, [
              ...
              [
                _c(
                  ...
                  [
                    ...
                    _c(
                      "span",
                      { staticClass: "sm:block text-teal-500 font-normal" },
                      [
                        _vm._v(
            ...
            _c(
              "div",
              {
                staticClass: "mt-12 xl:mt-0 px-6 flex-shrink-0 hidden md:block"
              },
              [
                _c("img", {
                  staticClass: "border-0 mx-auto rounded-lg",
                  staticStyle: { width: "40rem", height: "auto" },
                  attrs: {
                    src: "/storage/stock-images/school_kids.jpeg",
                    alt: "Credit: Adrianna Van Groningen",
                    title: "Credit: Adrianna Van Groningen"
                  }
                })
              ]
            )
