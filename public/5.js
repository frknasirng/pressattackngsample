...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    sendPasswordResetLinkLoadStatus: function sendPasswordResetLinkLoadStatus() {
      return this.$store.getters.getSendPasswordResetLinkLoadStatus;
    },
    sendPasswordResetLinkResponse: function sendPasswordResetLinkResponse() {
      return this.$store.getters.getSendPasswordResetLinkResponse;
    }
  },
  watch: {
    sendPasswordResetLinkLoadStatus: function sendPasswordResetLinkLoadStatus(val) {
      if (val === 1) {
        this.errors.splice(0, this.errors.length);
      } else if (val === 2) {} else if (val === 3) {
  ...
  methods: {
    ...
    sendPasswordResetLink: function sendPasswordResetLink(credentials) {
...
var render = function() {
  ...
  return _c("form", { staticClass: "mt-7" }, [
    ...
    _vm._v(" "),
    _vm.sendPasswordResetLinkResponse.status === 200
      ? _c(
          "div",
          {
            staticClass:
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _vm.sendPasswordResetLinkLoadStatus !== 1
          ? _c("div", { staticClass: "md:w-2/3" }, [
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.sendPasswordResetLink(_vm.credentials)
                    }
                  }
                },
                [_vm._v("\n\t\t\t\tSend Link\n\t\t\t")]
